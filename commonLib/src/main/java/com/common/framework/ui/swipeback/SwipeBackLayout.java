package com.common.framework.ui.swipeback;
...
import com.common.R;
import com.common.framework.ui.swipeback.app.SwipeBackListenerActivityAdapter;
...
public class SwipeBackLayout extends FrameLayout {
    ...
    public SwipeBackLayout(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.com_SwipeBackLayoutStyle);
    }
    ...
    public SwipeBackLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        int mode = EDGE_FLAGS[a.getInt(R.styleable.com_SwipeBackLayout_com_edge_flag, 0)];
